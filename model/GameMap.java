...
public class GameMap {
	...
	private void setMap(int mapNum) {
		...
		case 2:
			...
			break;
		case 3:
			x = new int[] { 0,   0, 790,   0, 300,   0, 700};
			y = new int[] { 0,   0,   0, 490, 100, 200, 200};
			w = new int[] {10, 800,  10, 800, 250, 200, 100};
			h = new int[] {500, 10, 800,  10, 300, 400, 500};
			break;
		case 4:
			x = new int[] { 0,   0, 790,   0};
			y = new int[] { 0,   0,   0, 490};
			w = new int[] {10, 800,  10, 800};
			h = new int[] {500, 10, 800,  10};
			break;
		default:
